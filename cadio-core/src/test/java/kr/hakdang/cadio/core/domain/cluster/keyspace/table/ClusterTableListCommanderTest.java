...
public class ClusterTableListCommanderTest extends IntegrationTest {
    ...
    void listTables() {
        ...
        assertThat(sut.getTables().get(0).getTableName()).isEqualTo("test_table_1");
        assertThat(sut.getTables().get(0).getComment()).isEqualTo("test_table_one");
        assertThat(sut.getTables().get(0).getOptions()).containsEntry("bloom_filter_fp_chance", 0.01);
